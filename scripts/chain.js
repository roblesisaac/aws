...
Chain.prototype.build = function(master) {
  ...
  var hasVariations = !Array.isArray(this.instruct) && typeof this.instruct == "object" && !this.instruct.if;
  if(hasVariations) {
    for(var key in this.instruct) {
      this[key] = this.addVariation(this.instruct[key]); 
    }
  }
};
Chain.prototype.addVariation = function(variation) {
  var _parent = this;
...
Instance.prototype.automate = function(number) {
  ...
  if(step._is("aVariation")) {
    var variation = step._name;
    variation.call(instance, storage).then(instance.continue.bind(instance));
    return instance;
  }
  ...
  return {
    ...
    _is: function(condition) {
      ...
      return {
        ...
        aVariation: function() {
          var variation = instance._parent && instance._parent[stepName];
          if(variation) self._name = variation;
          return !!variation;
        },
        aChain: function(){
          var nested = stepName;
